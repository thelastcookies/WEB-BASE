...
export const staticActions = createTree<ActionRecordRaw>([
  {
    ...
    children: [{
      ...
      showInMenu: true,
      url: 'meta-diagram',
      resource: 'samples/diagram/MetaDiagramSample.vue',
      meta: {
        href: 'test.cfd',
      },
    }, {
      ...
      showInMenu: true,
      url: 'props-diagram',
      resource: 'samples/diagram/PropsDiagramSample.vue',
    }],
  }, {
...
export const silenceActions = createTree<ActionRecordRaw>([
  {
    id: 'DIAGRAM',
    actionId: 'DIAGRAM',
    title: '组态图',
